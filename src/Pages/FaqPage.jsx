...
const FaqPage = () => {
  ...
  const faqs = [
    ...
    {
      question: "পণ্য কত দিনের মধ্যে ডেলিভারি করা হয়?",
      answer: "ঢাকার মধ্যে ২৪ ঘণ্টার মধ্যে এবং ঢাকার বাইরে ৪৮ ঘণ্টার মধ্যে পণ্য ডেলিভারি করা হয়।"
    },
    {
      question: "প্রোডাক্টের ত্রুটি থাকলে কী করব?",
      answer: "ডেলিভারি ম্যানের সামনে প্রোডাক্ট চেক করে নিতে হবে। ত্রুটি পেলে সাথে সাথে রিটার্ন করতে হবে।"
    },
    {
      question: "পেমেন্ট অপশন কী কী?",
      answer: "আমরা নগদ, বিকাশ, রকেট এবং ব্যাংক ট্রান্সফার এর মাধ্যমে পেমেন্ট গ্রহণ করি।"
    },
    {
      question: "কিভাবে অর্ডার ট্র্যাক করতে পারি?",
      answer: "অ্যাপসের মাধ্যমে আপনি আপনার অর্ডারের লাইভ ট্র্যাকিং দেখতে পারবেন।"
    },
    ...
    {
      question: "প্রফিট কিভাবে এবং কত দিনের মধ্যে দেওয়া হয়? (Reseller)",
  ...
  return (
    <>
      ...
      <div className={`${styles.section} my-8   lg:mt-28 mt-2`}>
