  ...
  return (
    <motion.div
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-[18px] 800px:text-[25px] font-[600] pb-2  text-gray-700">
          Address
        </h1>

        <div
          className={`${styles.button} 800px:w-[20%] w-[40%] text-white hover:!text-black !rounded-[5px] transition !h-10 800px:!h-11 border  bg-orange-600  `}
