...
const ChangePassword = () => {
  ...
  return (
    <div className="w-full px-5">
      <h1 className="text-[18px] text-gray-700 text-center 800px:text-[25px] font-[600] pb-2 ">
        Change Password
      </h1>
      ...
      <form
        ...
        <motion.div
          ...
          <label className="pb-2 text-gray-700">Old Password</label>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className="w-full 800px:w-[60%]">
          <label className="pb-2 text-gray-700">New Password</label>
          <div className="mt-1 relative">
            <input
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className="w-full 800px:w-[60%]">
          <label className="pb-2 text-gray-700">Confirm Password</label>
          <div className="mt-1 relative">
            <input
        ...
        <motion.div
          ...
          <input
            type="submit"
            value="Submit"
            className={`${styles.button} !w-full font-semibold !rounded-[4px] !-h-9 !text-white  bg-orange-500      active:scale-95 transition duration-300`}
          />
        </motion.div>
        {/* toast message */}
        <ToastContainer
