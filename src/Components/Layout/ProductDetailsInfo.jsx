...
const ProductDetailsInfo = ({ data }) => {
  ...
  return (
    <div className="  px-3 py-2 800px:px-10 rounded mt-10">
      <div className="flex items-center justify-between w-full border-b pt-10 pb-2 ">
        <div className="relative">
          <h5
            className="text-[18px] text-gray-700 px-1 leading-5  font-[600] cursor-pointer 800px:text-[20px]"
            onClick={() => setActive(1)}>
            Product Details
          </h5>
          {active === 1 ? (
        ...
        <div className="relative">
          <h5
            className="text-[18px] px-1 leading-5  text-gray-700 font-[600] cursor-pointer 800px:text-[20px]"
            onClick={() => setActive(2)}>
            Product Reviews
          </h5>
          {active === 2 ? (
      ...
      {active === 1 ? (
        <motion.div
          ...
          className="mt-5">
          <p className="text-[18px] text-gray-700 pb-5 py-2 whitespace-pre-line leading-8">
          ...
          <p className="text-[18px] pb-5 text-gray-700 py-2 whitespace-pre-line leading-8">
        ...
        <div className="w-full block 800px:flex pt-5 pb-6">
          <motion.div
            ...
            <div className="flex items-center">
              ...
              <div className="pl-3">
                <h3 className={`${styles.shop_name} text-gray-700`}>{data.shop.name}</h3>
          ...
          <motion.div
            ...
            <div className="text-left text-gray-700">
              <h5 className=" ">
                Joined on: <span className=" ">21 May,2023</span>
              </h5>

              <h5 className=" pt-3">
                Total Products: <span className="">200</span>
              </h5>

              <h5 className="pt-3">
                Total Reviews: <span className="">486</span>
              </h5>

              <Link to="/shop/:id">
                <button
                  className={`${styles.button} !h-11 !rounded text-gray-700 !mt-3`}>
                  Visit Shop
                </button>
              </Link>
            </div>
