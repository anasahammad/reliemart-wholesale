  ...
  return (
    <motion.div
      ...
      className={`w-full block lg:flex p-3 sm:p-12 rounded-lg ${
        active ? "unset" : "mb-12"
      }   bg-white border border-gray-300 shadow-sm text-gray-700 mt-20`}>
      ...
      <div className="w-full lg:w-[50%] flex flex-col justify-center">
        <h2 className={`${styles.productTitle}   text-gray-700`}>
        ...
        <div className="w-full flex justify-between py-2">
          <div className="flex">
            <h5 className="font-[500] line-through text-[18px] pr-3   text-red-700">
              $1099
            </h5>
            <h5 className="font-bold text-[20px]   text-green-500 font-Roboto">
              $999
            </h5>
          </div>
          <span className="  pr-3 text-green-600   font-bold  text-[17px]">
            120 sold
          </span>
        </div>
        ...
        <div className="flex items-end justify-end mt-5">
          <span className="flex text-white items-center gap-2 cursor-pointer transition ease-linear hover:text-[#475ad2] text-[#333] text-[17px]">
