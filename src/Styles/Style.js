const styles = {
  custom_container: "w-11/12 sm:block",
  heading:
    "text-[27px] text-center md:text-start font-[600] lg:ml-4 font-Roboto pb-[20px]",
  section: "w-11/12 mx-auto",
  sectionSmall: "md:w-11/12 w-full mx-auto",
  ...
  button:
    "w-[150px]  bg-gray-900  h-[50px] px-4 py-2 gradient-bg text-white text-sm font-semibold rounded-full shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2",
  cart_button:
    "px-[20px] h-[38px] rounded-[20px] bg-[#f63b60] flex items-center justify-center cursor-pointer",
  cart_button_text: "text-[#fff] text-[14px] font-[600]",
